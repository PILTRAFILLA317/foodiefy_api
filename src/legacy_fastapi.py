...
class RecipeAnalyzer:
    def __init__(self):
        ...
        if hasattr(self.gemini_key, 'get_secret_value'):
            self.gemini_key = self.gemini_key.get_secret_value()
...
async def analyze_recipe_endpoint(request: Request):
    global transcriber, recipe_analyzer
